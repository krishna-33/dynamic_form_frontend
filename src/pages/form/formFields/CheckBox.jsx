...
export default function CustomCheckBox({
  ...
  const onDelete = (ind) => {
    const data = options?.filter((options, index) => index != ind);
    setAnswer(data);
    setOptions(data);
  };
      ...
      >
        ...
        {isNew && (
          <TextField
            ...
            onKeyDown={(event) =>
              event.key === "Enter" && onUpdateOptions(options.length)
            }
